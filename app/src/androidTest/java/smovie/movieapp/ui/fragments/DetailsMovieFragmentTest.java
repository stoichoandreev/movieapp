...
import smovie.movieapp.FragmentTestRule;
 ...
 */
public class DetailsMovieFragmentTest {
    @Rule
    public FragmentTestRule<DetailsMovieFragment> mFragmentTestRule = new FragmentTestRule<>(DetailsMovieFragment.class);
